...
function Nav({ Component, pageProps }) {
    ...
    return (
      <>
        ...
        <ul>
          <li>
            <a href="./index.html"><img src="/Asset 1.png" alt="Logo" layout="fill" /></a>
          </li>
          ...
          <li><a href="./account.html" className="rounded-button">My Account</a></li>
          <li><a className="rounded-button">Connect Wallet</a></li>
          <svg className={mobileNavVisibility?"mobile-nav-icon":"mobile-nav-icon visible"} onClick={()=>{toggleNavVisiblity()}}>
